...
public class SolutionHashcode13 {
...
//                , "f"
        ...
        for (int i = 0; i < inputs.length; ++i) {
            ...
            threads[i] =new Thread(() -> {
                var result = new SolutionHashcode13();
                        ...
                        (Comparator.<Street>
                         ...
                         //   AtomicInteger m= new AtomicInteger();
                          ...
                          AtomicInteger a = new AtomicInteger();
                                  s.cars().stream().min((o1, o2) -> {return o2.earliestReleaseDay-o1.earliestReleaseDay;}).ifPresentOrElse(car1 -> a.set(car1.earliestReleaseDay),() -> {});
...
//                            });
                ...
                while(!process.isEmpty()){
                    ...
                    if(stnext !=null) {
                        ...
                        c.earliestReleaseDay = forwardtime+ stnext.time+1;
