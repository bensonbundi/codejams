...
Add book occurrence count - common books less priority sort by 
*/
  ...
  constructor(pos, score) {
   ...
   getRemainingLibs() {
    ...
    var libs = libsLeft.filter(e=>{//filter my libs
      ...
      return !e.reg;
    }).sort(function (a, b) {//sort descending
    ...
    function registerByBook() {
      ...
      while ( (currentBook = getNextBook())!=null && daysLeft>= 0){
        ...
        if(remainingLibs.length!=0){
          ...
          console.log(`out of libs to mine this book: ${currentBook.pos} daysleft: ${daysLeft}`);
